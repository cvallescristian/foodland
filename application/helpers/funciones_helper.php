<?php 
	...
	function reducir_imagen($id){
		
		$img_origen = imagecreatefromjpeg( base_url().'img/slider/'.$id.'.jpg' );
		...
		imagejpeg( $img_destino, "img/tipo_producto/".$id.".jpeg"); //se guarda la nueva foto 
